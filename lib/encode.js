...
const MIN_INT64 = BigInt(-2) ** BigInt(63) + BigInt(1);
...
function _encode(bytes, defers, value) {
  ...
  switch (typeof value) {
    ...
    case 'bigint':
      ...
      hi = Number(value >> BigInt(32));
      lo = Number(value & BigInt(0xffffffff));
      bytes.push(0xd7, 1, hi >> 24, hi >> 16, hi >> 8, hi, lo >> 24, lo >> 16, lo >> 8, lo);
      return 10;
    default:
